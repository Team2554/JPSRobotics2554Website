<svelte:head>
	<title>Team 2554: Executive Board</title>
</svelte:head>
...
<div class="p-20 bg-emerald-900 text-center flex flex-col justify-center align-middle">
	...
	<div class="grid grid-cols-3 text-white mt-5">
		...
		<div>
			...
			<p class="text-2xl mt-4">Mr. Kearney</p>
		</div>
		<div>
...
<div class="pt-2 pb-10 mt-12 bg-amber-400">
	...
	<div class="text-center mt-7 text-2xl">
		...
		<br />
		<p>
			<span class="font-semibold">2021 Presidents:</span> Ahnaf Rahim, Shivan Mukherjee, Shicharan K.S.
		</p>
		<br />
		<p>
			<span class="font-semibold">2020 Presidents:</span> Himani Vaid & Jeevanatham Murugan
		</p>
		<br />
		<p>
			<span class="font-semibold">2019 Presidents:</span> Vipul, Neeraj
		</p>
		<br />
		<p>
			<span class="font-semibold">2018 Presidents:</span> Samarth, Kevin
		</p>
		<br />
		<p>
			<span class="font-semibold">2017 Presidents:</span> Samarth, Daniel
		</p>
		<br />
		<p>
			<span class="font-semibold">2016 Presidents:</span> Adam, Eric
		</p>
		<br />
		<p>
			<span class="font-semibold">2015 Presidents:</span> Mandev, Susan
		</p>
		<br />
		<p>
			<span class="font-semibold">2014 Presidents:</span> Sam Mao, Nikki Huang
		</p>
	</div>
</div>
